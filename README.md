...
A user-friendly Next.js application for exploratory data analysis in the browser. Users can upload CSV, TSV, JSON, XLS, or XLSX files and instantly receive:
